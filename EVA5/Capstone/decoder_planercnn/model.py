...
import decoder_planercnn.utils as utils
...
class MaskRCNN(nn.Module):
    ...
    def forward(self, planercnn_ip, encoder_op):

        input = planercnn_ip['input']
        mode = planercnn_ip['mode']
        use_nms = planercnn_ip.get('use_nms', 1)
        use_refinement = planercnn_ip.get('use_refinement', False)
        return_feature_map = planercnn_ip.get('return_feature_map', False)
        ...
        ## Feature extraction
        [p2_out, p3_out, p4_out, p5_out, p6_out] = self.fpn(molded_images, encoder_op)
