...
from decoder_planercnn.plane_dataset import *

from decoder_yolo.utils.utils import xyxy2xywh, xywh2xyxy
from decoder_yolo.utils.datasets import *

import decoder_midas.utils as utils
from decoder_midas.transforms import Resize, NormalizeImage, PrepareForNet
...
class create_data(Dataset):
    def __init__(self, yolo_params, planercnn_params, midas_params):
        ...
        self.Yolo_transform = Compose([Resize(
                                        512,
                                        512,
                                        resize_target=None,
