...
from Decoder.YoloV3.utils.datasets import *
from Decoder.YoloV3.utils.utils import *

from config.options import *

from Decoder.PlaneRCNN.config import InferenceConfig# PlaneConfig
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='Decoder/YoloV3/cfg/yolov3-custom.cfg', help='*.cfg path')
    parser.add_argument('--names', type=str, default='data/customdata/custom.names', help='*.names path')
    parser.add_argument('--weights', type=str, default='/content/gdrive/My Drive/Yolo/visionet_best.pt', help='weights path')
