...
def yolo_detect_args():
    ...
    parser.add_argument('--cfg', type=str, default='decoder_yolo/cfg/yolov3-custom.cfg', help='*.cfg path')
    parser.add_argument('--names', type=str, default='data/customdata/custom.names', help='*.names path')
    parser.add_argument('--weights', type=str, default='/content/drive/MyDrive/EVA_Capstone/model_last.pt', help='weights path')
